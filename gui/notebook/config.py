...
from gooey_.gui.util import wx_util
from gooey_.util.functional import getin, flatmap, merge, compact, indexunique
from gooey_.gui.components.widgets.radio_group import RadioGroup
...
class ConfigPage(ScrolledPanel):
    ...
    def reifyWidget(self, parent, item):
        ...
        from gooey_.gui.components import widgets
