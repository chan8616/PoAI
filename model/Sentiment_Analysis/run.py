...
@Gooey(image_dir='image/nlp', optional_cols=2, program_name="Sentiment Analysis", default_size=(800,600 ))
def run():
    parser = GooeyParser()
    ...
    data_group = test_parser.add_argument_group("Data", gooey_options={'show_border': True}, )
    data_group = args_data.add(data_group)
