...
from .build_config import DenseNet121LAYERS


class DenseNet121TrainConfig(TrainConfig):
    WEIGHT = None
    ...
    def __init__(self):
        super(DenseNet121TrainConfig, self).__init__()
        for k, v in DenseNet121LAYERS.items():
            if 'all' == k:
                pass
            elif 'heads' == k:
                pass
