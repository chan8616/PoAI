...
def run_parser(
    ...
    return runlib.run_parser(parser,
                             ...
                             test_config=DenseNet121TestConfig(),
                             train_configs=OrderedDict([
                                 ('train_olivetti_faces', DenseNet121OlivettiFacesConfig()),
...
def run(config):
    return runlib.run(Model(), config, DenseNet121TrainConfig())
