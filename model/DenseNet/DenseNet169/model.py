...
from keras.applications.densenet import DenseNet169  # type: ignore
...
TF_WEIGHTS_PATH_NO_TOP = (
        ...
        'v0.8/densenet169_weights_tf_dim_ordering_tf_kernels_notop.h5')


class Model(modellib.KerasAppBaseModel):
    def __init__(self, model_config=ModelConfig()):
        super(Model, self).__init__(DenseNet169, model_config)
