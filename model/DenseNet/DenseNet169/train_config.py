...
from .build_config import DenseNet169LAYERS


class DenseNet169TrainConfig(TrainConfig):
    WEIGHT = None
    ...
    def __init__(self):
        super(DenseNet169TrainConfig, self).__init__()
        for k, v in DenseNet169LAYERS.items():
            if 'all' == k:
                pass
            elif 'heads' == k:
                pass
