...
from .build_config import DenseNet201LAYERS


class DenseNet201TrainConfig(TrainConfig):
    WEIGHT = None
    ...
    def __init__(self):
        super(DenseNet201TrainConfig, self).__init__()
        for k, v in DenseNet201LAYERS.items():
            if 'all' == k:
                pass
            elif 'heads' == k:
                pass
