...
from .config_samples import (DenseNet201Config,
...
def build_parser(
    ...
    return buildlib.build_parser(parser,
                                 build_config=DenseNet201Config(),
                                 build_configs=OrderedDict([
                                     ('build_olivetti_faces', DenseNet201OlivettiFacesConfig()),
                                     ('build_cifar10', DenseNet201CIFAR10Config()),
                                     ('build_imagenet', DenseNet201ImagenetConfig()),
                                 ]))
