...
from .build_config import MobileNetLAYERS


class MobileNetTrainConfig(TrainConfig):
    WEIGHT = None
    ...
    def __init__(self):
        super(MobileNetTrainConfig, self).__init__()
        for k, v in MobileNetLAYERS.items():
            if 'all' == k:
                pass
            elif 'heads' == k:
                pass
