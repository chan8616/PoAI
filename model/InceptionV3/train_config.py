...
from .build_config import InceptionV3LAYERS


class InceptionV3TrainConfig(TrainConfig):
    WEIGHT = None
    ...
    def __init__(self):
        super(InceptionV3TrainConfig, self).__init__()
        for k, v in InceptionV3LAYERS.items():
            if 'all' == k:
                pass
            elif 'heads' == k:
                pass
