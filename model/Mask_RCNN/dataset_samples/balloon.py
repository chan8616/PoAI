...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset, auto_download):
        ...
        annotations = json.load(open(
            os.path.join(dataset_dir, "via_region_data.json")))
    ...
    def auto_download(self, dataDir, dataType):
        # TODO
        """Download the Balloon dataset/annotations if requested.
        dataDir: The root directory of the COCO dataset.
        dataType: What to load (train, val)
        """
