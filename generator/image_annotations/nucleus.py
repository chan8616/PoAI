    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        for f in next(os.walk(mask_dir))[2]:
            if f.endswith(".png"):
                m = skimage.io.imread(
                        os.path.join(mask_dir, f)).astype(np.bool)
                mask.append(m)
...
def nucleus_parser(parser: GooeyParser = GooeyParser()):
...
if __name__ == '__main__':
    ...
    parser = Gooey(nucleus_parser)(GooeyParser(
